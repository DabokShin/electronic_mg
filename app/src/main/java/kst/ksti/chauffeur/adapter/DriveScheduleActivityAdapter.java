...
import kst.ksti.chauffeur.activity.DriveScheduleActivity;
...
public class DriveScheduleActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<AllocationSchedule> mList;
    private WeakReference<DriveScheduleActivity> activityWeakReference;
    ...
    public DriveScheduleActivityAdapter(Context context, ArrayList<AllocationSchedule> list, int callType) {
        activityWeakReference = new WeakReference<>((DriveScheduleActivity)context);
        this.mList = list;
    ...
    private class ScheduleItemActivityViewHolder extends RecyclerView.ViewHolder {
        ...
        ScheduleItemActivityViewHolder(View view, boolean isSingle) {
            super(view);
        ...
        void init(final int pos) {
            ...
            String afterDay = "" + (DateUtils.afterDay(mList.get(pos).resvDatetime));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new DriveScheduleActivityAdapter.ScheduleItemActivityViewHolder(view, false);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder scheduleItem, int i) {
        ((DriveScheduleActivityAdapter.ScheduleItemActivityViewHolder)scheduleItem).init(i);
    }
