...
public class FacePhotoInfoDialog extends Dialog {
    private ImageButton mClosButton;
    private Button mSingleButton;
    private FacePhotoInfoDialog dialog = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.face_photo_info_dialog);
    ...
    public FacePhotoInfoDialog(Context context) {
